...
- [Установка сервера 1C Предприятие на GNU/Linux](#установка-сервера-1c-предприятие-на-gnulinux)
    - [Упражнение 1: Подготовка разрешения имён в сети и размещение дистрибутивов на сервера для последующей установки](#упражнение-1-подготовка-разрешения-имён-в-сети-и-размещение-дистрибутивов-на-сервера-для-последующей-установки)
...
## Упражнение 1: Подготовка разрешения имён в сети и размещение дистрибутивов на сервера для последующей установки
